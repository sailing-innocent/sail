...
int threeSumClosest(std::vector<int>& nums, int target)
{
    ...
    */
    ...
    // std::cout << res_i << " " << res_j << " " << res_k << std::endl;
    return nums[res_i] + nums[res_j] + nums[res_k];
}

TEST(Leetcode016, Three_Sum_Closest)
{
    std::vector<int> nums = { -1, 2, 1, -4 };
    int res = threeSumClosest(nums, 1);
    EXPECT_EQ(res, 2);
    nums = { 1, 1, 1, 0 };
    res = threeSumClosest(nums, 100);
    EXPECT_EQ(res, 3);
